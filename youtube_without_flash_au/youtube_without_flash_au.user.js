...
function writePlayerNormal() {
    playerDiv.innerHTML = '<embed type="application/x-mplayer2" src="' + video_url_normal + '&begin=0' +'" scale="tofit" width="640" height="388"><br>';
}
function writePlayerHigh() {
    playerDiv.innerHTML = '<embed type="application/x-mplayer2" src="' + video_url_high + '&begin=0' +'" scale="tofit" width="640" height="388"><br>';
}
function writePlayerHD() {
    playerDiv.innerHTML = '<embed type="application/x-mplayer2" src="' + video_url_HD + '&begin=0' +'" scale="tofit" width="640" height="388"><br>';
}
...
function showPreferences() {
    ...
    if (document.getElementById("preferences") != null) {
        ...
        //set select to what it is set to, or hd if not set
        document.getElementById("preferencesDefaultQuality").value = GM_getValue("defaultQuality", "hd");
...
var defaultQuality = GM_getValue("defaultQuality", "hd");
