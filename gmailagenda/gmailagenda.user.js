...
var timeZones =		[{ value: "Pacific/Midway", offset: 660 },{ value: "Pacific/Honolulu", offset: 600 },{ value: "Pacific/Marquesas", offset: 570 },
					 { value: "America/Anchorage", offset: 540 },{ value: "America/Los_Angeles", offset: 480 },{ value: "America/Phoenix", offset: 420 },
					 { value: "America/Chicago", offset: 360 },{ value: "America/New_York", offset: 300 },{ value: "America/Caracas", offset: 270 },
					 { value: "America/Halifax", offset: 240 },{ value: "America/St_Johns", offset: 210 },{ value: "America/Araguaina", offset: 180 },
					 { value: "America/Noronha", offset: 120 },{ value: "Atlantic/Azores", offset: 60 },{ value: "Etc/GMT", offset: 0 },
					 { value: "Europe/Paris", offset: -60 },{ value: "Europe/Athens", offset: -120 },{ value: "Europe/Moscow", offset: -180 },
					 { value: "Asia/Tehran", offset: -210 },{ value: "Asia/Muscat", offset: -240 },{ value: "Asia/Kabul", offset: -270 },
					 { value: "Asia/Tashkent", offset: -300 },{ value: "Asia/Calcutta", offset: -330 },{ value: "Asia/Katmandu", offset: -345 },
					 { value: "Asia/Dhaka", offset: -360 },{ value: "Asia/Rangoon", offset:- 390 },{ value: "Asia/Bangkok", offset: -420 },
					 { value: "Asia/Hong_Kong", offset: -480 },{ value: "Asia/Tokyo", offset: -540 },{ value: "Australia/Adelaide", offset: -570 },
					 { value: "Australia/Sydney", offset: -600 },{ value: "Asia/Magadan", offset: -660 },{ value: "Pacific/Norfolk", offset: -690 },
					 { value: "Pacific/Fiji", offset: -720 },{ value: "Pacific/Enderbury", offset: -780 }];
timeZones.find = function( value ) {

	for( var i = 0; i < this.length; i++ ) {
		if ( this[ i ].offset == value ) {
			return this[ i ].value;
		}
	}
...
$( document ).ready( function() {
	...
	if ( window.location.href.toLowerCase().indexOf( "/calendar/" ) != -1 ) {
		...
		if ( window.location.href.indexOf( "&src=" ) == -1 ) {
			...
			try {
				...
				$( "#calendarListButton1", document )[ "0" ].dispatchEvent( evt );
	...
	// there needs to be atleast 4 frames to be loaded
		...
		$( "#cal" )[ "0" ].src = http[ 0 ] + "://www.google.com/calendar/" + ( urlParts != null ? ( "hosted/" + urlParts[ 1 ] + "/" ) : "" ) + "embedhelper";
		...
		$( window ).resize( function() {
			...
			try {
				$( "#nameDisplay #text" ).height( $( window ).height() - nameHeightOffset );
			}
			catch(e){}
						...
						GM_xmlhttpRequest(
							{
								...
								onload: function( data ) {
									...
									//GM_log( data.responseText.replace( /gCal\$/g, "" ) );
									
									var feed = eval( "(" + data.responseText.replace( /gCal\$/g, "" ) + ")" ).feed;
									GM_setValue( "account", feed.author[0].email.$t + "::" );
									GM_setValue( "feedData", data.responseText.replace( /gCal\$/g, "" ) );
									
									var url = http[ 0 ] + "://www.google.com/calendar/" + ( urlParts != null ? ( "hosted/" + urlParts[ 1 ] + "/" ) : "" ) + "embed?showTitle=0&showNav=1&showDate=0&showTabs=0&mode=AGENDA&wkst=1&bgcolor=%23FFFFFF&ctz=" + timeZones.find( new Date( new Date().getFullYear(), 1, 1 ).getTimezoneOffset() );
