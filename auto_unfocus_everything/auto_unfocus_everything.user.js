// ==UserScript==
// @name           Auto unfocus everything
// @namespace      arvid.jakobsson@gmail.com
// @description    Always runs unfocus onload, so that no element is focused. 
// @include        *
// ==/UserScript==


$x("//input").forEach(function (n) n.blur())

document.body.addEventListener('load', unfocus, false);
unfocus();
...
// window.setInterval(unfocus, 100);
