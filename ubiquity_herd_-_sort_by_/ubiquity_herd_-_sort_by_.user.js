...
var herdSorter = {
  ...
  setListeners: function() {
    this.rows = $x(this.unstable.rowxp);
...
//    tictac.tic();
    ...
    this.rows.sort(function (rowa, rowb) {
		     var texta = $xs(headerObj.cell_xp, rowa).textContent,
		     textb = $xs(headerObj.cell_xp, rowb).textContent;
...
profile(herdSorter).setListeners();
